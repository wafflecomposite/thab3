...
namespace NWH.VehiclePhysics2.Effects
{
    ...
    public class SkidmarkGenerator
    {
        ...
        public bool Initialize(WheelComponent wheelComponent, GameObject skidmarkContainer,
            ...
            float groundOffset, float smoothing, float lowerIntensityThreshold, bool fadeOverDistance,
        ...
        public void Update(int surfaceMapIndex, float targetIntensity, float albedoIntensity, float normalIntensity,
            Vector3            velocity,        float dt)
        {
            ...
            if (targetIntensity < _lowerIntensityThreshold)
            {
                _intensity       = 0;
                _wasGroundedFlag = false;
            }
            ...
            {
                _intensity = Mathf.SmoothDamp(_intensity, targetIntensity, ref _intensityVelocity, _smoothing);
            }
