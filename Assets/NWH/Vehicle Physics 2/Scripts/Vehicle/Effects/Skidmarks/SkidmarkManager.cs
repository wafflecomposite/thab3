        ...
        public override void Initialize()
        {
            ...
            foreach (WheelComponent wheelComponent in vc.powertrain.wheels)
            {
                ...
                skidmarkGenerator.Initialize(wheelComponent, skidmarkContainer, minDistance,
                                             vc.groundDetection.groundDetectionPreset.surfaceMaps.Count,
                                             maxMarksPerSection,
                                             persistentSkidmarks, persistentSkidmarkDestroyDistance, groundOffset,
                                             smoothing,
                                             lowerIntensityThreshold, fadeOverDistance,
                                             vc.groundDetection.groundDetectionPreset.fallbackSurfacePreset
                                               .skidmarkMaterial);
