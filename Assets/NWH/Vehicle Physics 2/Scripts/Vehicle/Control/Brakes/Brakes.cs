...
namespace NWH.VehiclePhysics2
{
    ...
    public class Brakes : VehicleComponent
    {
        ...
        public override void FixedUpdate()
        {
            ...
            if (brakeTorqueModifier < vc.input.Deadzone && brakeInput < vc.input.Deadzone)
            {
                return;
            }
            ...
            bool idleBrake = brakeWhileIdle && throttleInput < vc.input.Deadzone && currentGear == 0 &&
                             vc.Speed < 0.3f;
            ...
            if (brakeInput > vc.input.Deadzone)
            {
                AddBrakeTorqueAllWheels(brakeInput * brakeTorqueModifier * maxTorque);
                _isBraking = true;
            }
