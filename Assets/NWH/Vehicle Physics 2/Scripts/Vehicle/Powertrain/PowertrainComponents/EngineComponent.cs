...
namespace NWH.VehiclePhysics2.Powertrain
{
    ...
    public partial class EngineComponent : PowertrainComponent
    {
        ...
        public void GetPeakPowerRPM(out float peakPower, out float peakPowerRpm)
        {
            float maxY = 0f;
            float maxX = 1f;
            ...
            float forcedInductionCoeff = forcedInduction.useForcedInduction ? forcedInduction.powerGainMultiplier : 1f;
            peakPower = maxY * maxPower * forcedInductionCoeff;
            peakPowerRpm = maxX * maxRPM;
        }
